        ...
        <footer className="footer">
            <div className="container">
                <div className="footer-content">
                    ...
                    <div className="footer-section">
                        ...
                        <p className="footer-description">
                            Making laundry simple, fast, and convenient for everyone.
                    ...
                    <div className="footer-section">
                        ...
                        <ul className="footer-contact">
                            <li>
                                <a href="mailto:washtub@gmail.com">washtub@gmail.com</a>
                            </li>
                            <li>
                                <a href="tel:+94117906108">+94 (11)7 906 108</a>
                            </li>
                            <li>
                ...
                <div className="footer-bottom">
                    <p>&copy; 2024 WashTub. All rights reserved.</p>
